...
class department_list02 extends React.Component {
    ...
    componentDidMount() {
        ...
        dispatch({
            ...
            payload: {
                breadcrumb: { 
                    ...
                    detail: location.query.dept_name01 },
                menu: {
        ...
        dispatch({
            ...
            payload: { 
                p_dept_no: location.query.p_dept_no01, 
             },
        });
    }
    ...
    getAddData = value => {
        ...
        dispatch({
            ...
            payload: { 
                formdata: value, 
                p_dept_no: location.query.p_dept_no01,
                dept_name: location.query.dept_name01, 
            },
            callback: (code) => {
                if (code === 0) {
                    this.setState({
    ...
    getUpdateData = (value, dept_code) => {
        ...
        dispatch({
            ...
            payload: { formdata: value, dept_code, p_dept_no: location.query.p_dept_no01 },
            callback: (code) => {
                if (code === 0 || code === 2) {
                    dispatch({
                        type: 'department_model/updateState',
    ...
    deleteDept = (dept_code) => {
        ...
        dispatch({
            ...
            payload: { dept_code, p_dept_no: location.query.p_dept_no01 },
        });
    }

    // 下级部门.
    toThreeView = (code, name) => {
        const { location } = this.props;
        router.push({
            pathname: '/fht/systemManagement/department/department_list03',
            query: {
                p_dept_no02: code,
                dept_name02: name,
    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (text, record) => (
                    <span>
                        <Button size="small" type="link" onClick={this.toThreeView.bind(this, record.dept_code, record.name)}>下级部门</Button>
