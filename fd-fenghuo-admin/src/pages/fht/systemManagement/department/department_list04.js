...
class department_list02 extends React.Component {
    ...
    componentDidMount() {
        ...
        dispatch({
            ...
            payload: {
                breadcrumb: { 
                    ...
                    name04: location.query.dept_name02, href04: '',
                    detail: location.query.dept_name03 },
                menu: {
        ...
        dispatch({
            ...
            payload: { 
                p_dept_no: location.query.p_dept_no03, 
             },
        });
    }
    ...
    getAddData = value => {
        ...
        dispatch({
            ...
            payload: { 
                formdata: value, 
                p_dept_no: location.query.p_dept_no03,
                dept_name: location.query.dept_name03, 
            },
            callback: (code) => {
                if (code === 0) {
                    this.setState({
    ...
    getUpdateData = (value, dept_code) => {
        ...
        dispatch({
            ...
            payload: { formdata: value, dept_code, p_dept_no: location.query.p_dept_no03 },
            callback: (code) => {
                if (code === 0 || code === 2) {
                    dispatch({
                        type: 'department_model/updateState',
    ...
    deleteDept = (dept_code) => {
        ...
        dispatch({
            ...
            payload: { dept_code, p_dept_no: location.query.p_dept_no03 },
        });
    }
