...
class department_list01 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            // 控制对话框的显示.
        ...
        dispatch({
            ...
            payload: {
                breadcrumb: { 
                    ...
                    detail: location.query.dept_name 
                },
                menu: {
    ...
    deleteDept = (dept_code) => {
        ...
        dispatch({
            ...
            payload: { dept_code, p_dept_no: location.query.p_dept_no },
        });
    }
    ...
    toTwoView = (code, name) => {
        ...
        router.push({
            pathname: '/fht/systemManagement/department/department_list02',
            query: {
                p_dept_no01: code,
                dept_name01: name,
                p_dept_no: location.query.p_dept_no,
    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (text, record) => (
                    <span>
                        <Button size="small" type="link" onClick={this.toTwoView.bind(this, record.dept_code, record.name)}>下级部门</Button>
...
export default department_list01;