...
//        control_center.put("overallBusinessRisk_shichang", overallBusinessRisk_shichang_rs);
    ...
    public ApiResult fengxianfapiaotongji(@RequestBody Map map) {
        ...
        hm.put("type", "0 ~ 1k元");
        hm.put("name", "0 ~ 500元");
        hm.put("value", rmap.containsKey("l500")?(long)rmap.get("l500"):0);

        Map hm1 = new HashMap();
        hm1.put("type", "0 ~ 1k元");
        hm1.put("name", "500 ~ 1000元");
        hm1.put("value", rmap.containsKey("l1000")?(long)rmap.get("l1000"):0);
        
        Map hm2 = new HashMap();
        hm2.put("type", "1k ~ 5k元");
        hm2.put("name", "1000 ~ 3000元");
        hm2.put("value", rmap.containsKey("l3000")?(long)rmap.get("l3000"):0);
        
        Map hm3 = new HashMap();
        hm3.put("type", "1k ~ 5k元");
        hm3.put("name", "3000 ~ 5000元");
        hm3.put("value", rmap.containsKey("l5000")?(long)rmap.get("l5000"):0);
            
        Map hm4 = new HashMap();
        hm4.put("type", "5k元以上");
        hm4.put("name", "5000元以上");
        hm4.put("value", rmap.containsKey("g5000")?(long)rmap.get("g5000"):0);
     ...
     * @return
     */
    @RequestMapping(value = "/xiaoxitixingzhongxinAll", method = RequestMethod.POST)
    public ApiResult xiaoxitixingzhongxinAll(@RequestBody Map map) {

        List rs = chartMapper.xiaoxitixingzhongxinAll(map);
